...
class ChatMessage(Base):
    ...
    def __repr__(self):
        """
        Provide a concise developer-oriented representation of the ChatMessage instance.
        
        Returns:
            A string containing the class name and the instance's `id` and `role`, e.g. "<ChatMessage(id=<uuid>, role=user)>".
        """
