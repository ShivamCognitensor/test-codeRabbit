...
async def dashboard_overview(
    ...
    """High-level dashboard KPIs across all campaigns."""
...
async def campaign_calls(
    ...
    """Paginated list of calls/contacts for dashboard screens."""
...
async def call_detail(
    ...
    """Single call detail (full transcript + collected data)."""
...
async def campaign_leads(
    ...
    """Leads created for a campaign.

    If include_details=true and the user token is present, we will fetch lead details
    from Lead Ops (best effort). This is optional and may be slower.
    """
